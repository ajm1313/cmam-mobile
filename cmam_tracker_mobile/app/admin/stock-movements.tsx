...
const styles = StyleSheet.create({
  ...
  filterChip: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4, minWidth: 64, height: 30, paddingHorizontal: 10, borderRadius: 15 },
  ...
  chip: { alignItems: 'center', justifyContent: 'center', minWidth: 76, height: 36, paddingHorizontal: 10, borderRadius: 8, borderWidth: 1, borderColor: '#cbd5e1' },
