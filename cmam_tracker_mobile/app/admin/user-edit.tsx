...
export default function UserEditScreen() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const [userRes, rolesRes, regionsRes, facilitiesRes] = await Promise.all([
          api.get(`/v1/users/${id}/`),
          api.get('/v1/roles/'),
        ...
        setForm({
          ...
          role_id: u.role?.role_id ? String(u.role.role_id) : '',
          region_id: u.role?.region_id ? String(u.role.region_id) : '',
      ...
      <ScrollView style={[styles.container, { backgroundColor: colors.background }]} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View style={[styles.card, { backgroundColor: colors.surface }]}>
          ...
          <View style={styles.toggleWrap}>
            ...
            <TouchableOpacity
              style={[styles.toggleSwitch, { backgroundColor: form.is_active ? colors.success : colors.textMuted + '40' }]}
              onPress={() => update('is_active', !form.is_active)}
            >
